...
foreach ($data["articulos"] as $articulo) {
    ...
    <div class="article">
        ...
        <div class="article-meta">
            ...
            en <?=date('d-m-Y H:i:s', strtotime($articulo->getFecha()))?>
        </div>
    ...
    <div class="footer-meta">Categoria:
        ...
        <?php if($articulo->getEditado() && $articulo->getFechaEdicion() !== null){ ?> 
            <span class="article-edit">Ultima Edición: <?=date('d-m-Y H:i:s', strtotime($articulo->getFechaEdicion()))?></span> 
        <?php } ?>
    </div>
